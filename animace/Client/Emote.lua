...
if Config.EnableXtoCancel then 
  RegisterKeyMapping('emotes:cancelAnim', '~y~[Animace]~w~ Zrusit Animaci', 'keyboard', 'X')
...
if Config.MenuKeybindEnabled then
  RegisterKeyMapping('emotemenu', '~y~[Animace]~w~ Velke menu', 'keyboard', Config.MenuKeybind)
end
...
RegisterNetEvent('nb_anim:client:open', function()
  OpenEmoteMenu() 
end)
...
function OnEmotePlay(EmoteName)
  ...
  if InVehicle and not EmoteName.AnimationOptions.AllowedinCar then 
    return
  end
