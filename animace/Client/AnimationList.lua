...
--[[    ["testingemote"] = {"rcmextreme2atv", "idle_c", "Testing emotes", AnimationOptions =
   {
       EmoteLoop = true,
   }}, ]]
   --rcmextreme2atv
...
-----------------------------------------------------------------------------------------------------
   ...
   ["medibag"] = {"missheistdocksprep1hold_cellphone", "static", "Medibag", AnimationOptions =
   {
   ...
   ["heart"] = {"missheistdocksprep1hold_cellphone", "static", "Monitor srdce", AnimationOptions =
   {
